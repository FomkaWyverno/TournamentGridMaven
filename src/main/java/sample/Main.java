...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getClassLoader().getResource("sample.fxml"))); // Загружаем FXML файл с данными о сцене.
        primaryStage.setTitle("Tournament Grid"); // Ставим название приложения.
        Scene scene = new Scene(root, 1920, 1080); // Строим сцену FullHD
        primaryStage.getIcons().add(new Image("https://i.imgur.com/oekk2Km.png"));
